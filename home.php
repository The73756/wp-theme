...
<div class="page-banner-area page-contact" id="page-banner"style="background-image: url(<?php
	if (has_post_thumbnail(16)) {
		echo get_the_post_thumbnail_url(16);
	} else {
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
        <div class="banner-content content-padding">
          <h1 class="text-white"><?php the_field('banner-title', 16 ); ?></h1>
          <p><?php the_field('banner-description', 16 ); ?></p>
        </div>
      </div>
    </div>
  </div>
              ...
              case '3': ?>
                ...
                <div class="col-lg-12">
                  ...
                  ?>
                    ...
                    <a href="<?php echo get_the_permalink(); ?>" class="read-more"><?php _e('Read article', 'band_digital'); echo ' '; ?><i class="fa fa-angle-right"></i></a>
                  </div>
                </div>
